...
<html lang="en">
  ...
  <head>
    ...
    <title>INVIERTA EN ACCIONES OPCIONES E INDIECS EN ESTADOS UNIDOS</title>
            ...
            <div class="row">
              <div class="col-md-7">
                <ul class="list-inline top-contacts">
                  <li>
                   <i class="fa fa-envelope"></i> Email: <a href="mailto:info@inviertaconusa.co">info@inviertaconusa.co</a>
                  </li>
                  <li>
                     <i class="fa fa-phone"></i> Cel:  3173488808
                  </li>
                </ul>
              </div> 
              <div class="col-md-5">
      ...
      <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div id="div-forms">
                      <form  action="comprueba_login.php" class=""  method="post" id="login-form">
                          <h3 class="text-center">Login</h3>
                          <div class="modal-body">
                              <label for="username">Username</label> 
                              <input id="login_username"  class="form-control" type="text" name="login" placeholder="Enter username " required>
                              <label for="username">Password</label> 
                              <input id="login_password" class="form-control" type="password" name="password"  placeholder="Enter password" required>
                              <div class="checkbox">
                                  <label>
                      ...
                      <form action="reginver.php"  method="get" id="register-form" style="display:none;">
                          <h3 class="text-center">Register</h3>
                          <div class="modal-body"> 
                              <label for="username">Nombre</label> 
                              <input id="register_username" class="form-control" type="text" name="nom_inv" placeholder="Ingrese su nombre" required>
							  
							  <label for="username">Apellido</label> 
                              <input id="register_username" class="form-control" type="text" name="ape_inv" placeholder="Ingrese su Apellido" required>
							  
							   <label for="username">Cédula</label> 
                              <input id="register_username" class="form-control" type="text" name="ced_inver" placeholder="Ingrese su Identificacion" required>
							  
                              <label for="register_email">E-mail</label> 
                              <input id="register_email" class="form-control" type="text" name="email_inv" placeholder="Ingrese eMail" required>
                              <label for="register_password">Password</label> 
                              <input id="register_password" class="form-control" type="password" name="clave_inv"  placeholder="Password" required>
							  
							    <label for="username">Celular</label> 
                              <input id="register_username" class="form-control" type="text" name="cel_inv" placeholder="Ingrese su Celular" required>
							  
							    <label for="register_email">Capital Inicial</label> 
								<input id="register_username" class="form-control" type="text" name="inv_inicial" placeholder="Ingrese Capital inicial" required>
								
								
								<input placeholder="Barrio" type="hidden" name="tel_inv" value="555">
								<input placeholder="Direccion de domicilio" type="hidden" name="dir_inv" value="555">
								<input placeholder="Barrio" type="hidden" name="barrio_inv" value="555">
								 <input placeholder="ciudad" type="hidden" name="ciudad_inv"  value="555">
								  <input placeholder="Departamento" type="hidden" name="dep_inv" value="555">
								  <input placeholder="Departamento" type="hidden" name="pais_inv" value="555">
								    <input placeholder="Departamento" type="hidden" name="tel_inv" value="555">
              ...
              <div class="slide-1"></div>
                <div class="hero ">
                  <hgroup class="wow fadeInUp">
                      <h1>Te Asesoramos en: <span ><a href="" class="typewrite" data-period="2000" data-type='[" Como Invertir en la bolsa de Valores de E.U.", " Como Hacer Negocios rentables", " Como Generar Ganancias constantes"," Como Hacer tus sueños realidad"]'>
