...
$codigo= $osmer->getFunctionCodeDescription($tags);
 ...
 print '<pre>';
 //  echo $codigo;
$bid= $elArreglo6[1]; echo $elArreglo6[1]; 
 echo $bid; 
...
<table class="w3-table-all w3-hoverable">
     ...
     <tbody>	  
					...
					<div>
						 ...
						 <td class="alt"><?php  echo "pagina de Prueba" ;						// echo arrayAString($bid12,','); 						 arrayAString($bid,','); ?>						 <script type="text/javascript" src="aapl.js"></script></td>
