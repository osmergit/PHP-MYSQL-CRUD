 ...
 <div class="container">
  ...
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><a href="../operaciones.php">Operaciones Abiertas</a></li>
      <li><a href="#">Movimientos del día</a></li>
      <li><a href="#">Mi cuenta</a></li>
      <li><a href="#">Ingreso  de Dinero</a></li>
      <li><a href="#">Retiro de Dinero</a></li>
    </ul>
    <p><img src="../bandera.jpg" alt="Insertar logotipo aquí" name="Insert_logo" width="150" height="150" id="Insert_logo" style="background-color: #8090AB; display:block;" /></p>
    <p>&nbsp; </p>
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1>Instrucciones</h1>
    <p><img src="../toro.jpg" alt="Insertar logotipo aquí" name="Insert_logo" width="990" height="300" id="Insert_logo" style="background-color: #8090AB; display:block;" /></p>
    <h2>LA BOLSA DE VALORES USA</h2>
    <p></p>
