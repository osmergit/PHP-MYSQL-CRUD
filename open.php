 ...
 <div class="container">
  ...
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><a href="open.php">Operaciones Abiertas</a></li>
      <li><a href="visualizar.php">Movimientos del día</a></li>
  ...
  <div class="content">
	...
	include "adminopabiertas.php" ?></p>
      <h3><!-- end .content --></h3>
  </div>
  <div align="right"></div>
  <div class="footer">
   <img src="images.jpg" alt="Insertar logotipo aquí" name="Insert_logo" width="1260" height="200" id="Insert_logo" style="background-color: #8090AB; display:block;" />
    <!-- end .footer --></div>
  <!-- end .container --></div>
</body>
</html>
