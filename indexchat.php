...
<!-- End of LiveChat code -->
  ...
  <li><a href="#"><i class="icon-fixed-width icon-book"></i>Invierta</a></li>
  <li><a href="#"><i class="icon-fixed-width icon-pencil"></i> Login</a></li>
  <li><a href="#" onClick="abrirVentana('forregistrar.html')"><i class="icon-fixed-width icon-cogs"></i> Registrar</a></li>
  <li><a href="correo1.php"><i class="icon-fixed-width icon-cogs"></i>Email</a></li>
  <li class="active"><a href="#"><i class="icon-fixed-width icon-home"></i> Chat</a></li>
</ul>
								...
								<li><a href="#" class="icon fa-cogs" onclick="myFunction('Demo3')"><span class="label">Quienes Somos</span></a></li>
								
								<li><a href="#" class="icon fa-user"  onclick="myFunction('Demo2')" ><span class="label">LOGIN</span></a></li>
								<li><a href="#" class="icon fa-sign-in"  onClick="abrirVentana('forregistrar.html')"><span class="label">Registrese</span></a></li>
								<li><a href="correo1.php" class="icon fa-envelope-o"><span class="label">Email</span></a></li>
								<li color= "#f44271"><a href="#" class="fa fa-question-circle" ><span class="label">Chat</span></a></li>
							</ul>
						</nav>
						
...
<div id="Demo1" class="w3-container w3-hide">
	...
	<form  action="cambio.php" class=""  method="post">
   ...
   <div class="form-group">
    ...
    <input class="sampletext"  type="text" name="login" placeholder="Moneda USD" color="blue" bgcolor ="blue" >
    <span class="icon fa-user"></span></div>
	<div class="element-password"> 
    <input class="sampletext" type="text" name="password"  placeholder="Moneda2 EUR"><span class="icon fa-unlock"></span>
