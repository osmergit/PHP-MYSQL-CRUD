...
$codigoValor1 = 'aapl';
$request1 = 'http://finance.google.com/finance?q='. $codigoValor1. '&ei='.$ei;

$datos = file_get_contents($request1);
$columnas = explode("\n",$datos);
for ($x = 0; $x < count($columnas); $x ++)
{
$day1[]= explode(",",$columnas[$x]);	
	
}
$cambio = $day1[207];
$ultimo = $day1[204];
$capital = $day1[212];
$porcambioaapl = $day1[208];
print '<pre>';
//print_r($day[207]);

//aca termina Grilla AAPL


//aca INICIA FB grilla

$codigoValor1 = 'fb';
$request2 = 'http://finance.google.com/finance?q='. $codigoValor1. '&ei='.$ei;

$datos = file_get_contents($request2);
$columnas = explode("\n",$datos);
for ($x = 0; $x < count($columnas); $x ++)
{
$dayfb[]= explode(",",$columnas[$x]);	
	
}
$cambiofb = $dayfb[207];
$ultimofb = $dayfb[204];
$capitalfb = $dayfb[212];
$porcambiofb = $dayfb[208];
print '<pre>';
//print_r($day[207]);

//aca termina Grilla FB


//aca inicia ba grilla

$codigoValorba = 'ba';
$request3 = 'http://finance.google.com/finance?q='. $codigoValorba. '&ei='.$ei;

$datos = file_get_contents($request3);
$columnas = explode("\n",$datos);
for ($x = 0; $x < count($columnas); $x ++)
{
$dayba[]= explode(",",$columnas[$x]);	
	
}
$cambioba = $dayba[207];
$ultimoba = $dayba[204];
$capitalba = $dayba[212];
$porcambioba = $dayba[208];
print '<pre>';
//print_r($day[207]);

//aca termina Grilla ba

//aca inicia GOOGL grilla

$codigoValorgo = 'GOOGL';
$request4 = 'http://finance.google.com/finance?q='. $codigoValorgo. '&ei='.$ei;

$datos = file_get_contents($request4);
$columnas = explode("\n",$datos);
for ($x = 0; $x < count($columnas); $x ++)
{
$dayGO[]= explode(",",$columnas[$x]);	
	
}
$cambiogo = $dayGO[207];
$ultimogo = $dayGO[204];
$capitalgo = $dayGO[212];
$porcambiogo = $dayGO[208];
print '<pre>';
//print_r($day[207]);

//aca termina Grilla GOOGL



//aca inicia NVDA grilla
$symbolnv = 'NVDA';
$codigoValornv = 'NVDA';
$request5 = 'http://finance.google.com/finance?q='. $codigoValornv. '&ei='.$ei;

$datos = file_get_contents($request5);
$columnas = explode("\n",$datos);
for ($x = 0; $x < count($columnas); $x ++)
{
$daynv[]= explode(",",$columnas[$x]);	
	
}
$cambionv = $daynv[207];
$ultimonv = $daynv[204];
$capitalnv = $daynv[212];
$porcambionv = $daynv[208];
print '<pre>';
//print_r($day[207]);

//aca termina Grilla NVDA
...
if ($pos === false) {
   ...
   // echo " y existe en la posición $pos";
    ...
    echo '<span class="asset_status_up_down" style="color:red; font-size:28px;">'.$prut[0].'</span>';
		...
		//ACA SE MUESTRAN TODAS LAS ACCIONES 
		
		
		//aca validamos si es negativo o positivo
...
if ($pos === false) {
   // echo "La cadena '$findme' no fue encontrada en la cadena '$mystring'";
   //si es positivo ingresa por aca
    ...
    // echo '<span style="color:green; font-size:28px;">'.$prut[0].'</span>';
     		...
     		$pru= $day[207];
				echo("<th>");
		                echo "Precio Actual:";
				echo("</th>");	
			echo '<span style="color:green; font-size:40px;">'.$pa[0].$pa[1].'</span>';
					echo '<span style="color:green; font-size:28px;">'.$pru[0].'</span>';
						$pu= $day[208];
   ...
   //ho "La cadena '$findme' fue encontrada en la cadena '$mystring'";
   // echo " y existe en la posición $pos";
   //si es negativo ingresa por aca 
	echo  "";
    ...
    //echo '<span class="asset_status_up_down" style="color:red; font-size:28px;">'.$prut[0].'</span>';
		...
		echo("<th>");
				...
				echo("<th>");
						$pru= $day[207];
						echo '<span style="color:red; font-size:40px;">'.$pa[0].$pa[1].'</span>';
					echo("</th>");
					echo("<th>");
					echo '<span style="color:red; font-size:28px;">'.$pru[0].'</span>';
						$pu= $day[208];
						echo("</th>");
					echo("<th>");	
					echo '<span style="color:red; font-size:28px;">'.$pu[0].'</span>';
			echo("</th>");
		echo("</th>");
...
<table class="w3-table-all w3-hoverable">
     ...
     <tbody>	  
					...
					<div>
                   		...
                   		<td class="asset_status_up_down" style="color: rgb(0, 213, 50); font-size: 18px;"><i class="fa fa-caret-up"></i><?php 
						
						//aca iniciamos la validacion del signo
...
if ($pos === false) {
   ...
   //si es positivo ingresa por aca
    ...
    // echo '<span style="color:green; font-size:28px;">'.$prut[0].'</span>';
			...
			echo '<span style="color:green; font-size:20px;">'.$symbol.'</span>';
   ...
   //si es negativo ingresa por aca 
	...
	echo '<span class="asset_status_up_down" style="color:red; font-size:28px;"></span>';
    //echo '<span class="asset_status_up_down" style="color:red; font-size:28px;">'.$symbol.'</span>';
											...
											echo '<span style="color:red; font-size:20px;">'.$symbol.'</span>';
		...
		//aca termina la validacion
		 ...
		 ?></td>      
					 ...
					 <td><?php echo $ultimo[0].$ultimo[1]; ?>	</td>
                         <td><?php echo $pru[0]; ?>	</td>
						 <td class="alt"><?php echo $capital[0].$capital[1]; ?></td>
                         <td><?php echo  $cambio[0].$cambio[1]; ?></td>
                         <td class="alt"><?php echo $porcambioaapl[0]; ?></td>
...
?>
          ...
          <tbody>	  
                    <tr class="w3-hover-light-blue">
                         <td class="asset_status_up_down" style="color: rgb(255, 45, 19); font-size: 18px;"><i class="fa fa-caret-down"></i><?php
   ...
   //si es negativo ingresa por aca 
    ...
    //echo '<span class="asset_status_up_down" style="color:red; font-size:28px;">'.$symbol.'</span>';
		...
		//aca termina la validacion
						...
						?></td>
                        <td><?php echo $ultimofb[0].$ultimofb[1]; ?>	</td>
                         <td><?php echo $pru[0]; ?>	</td>
						 <td class="alt"><?php echo $capitalfb[0].$capitalfb[1]; ?></td>
                         <td><?php echo  $cambiofb[0].$cambiofb[1]; ?></td>
                         <td class="alt"><?php echo $porcambiofb[0]; ?></td>
                         <td><?php echo arrayAString($bid,','); ?></td>
                         <td class="alt"><?php echo arrayAString($bid,','); ?></td>
                         <td><?php echo arrayAString($bid,','); ?></td>
                         <td class="alt"><?php echo arrayAString($bid,','); ?></td>
   ...
   //si es negativo ingresa por aca 
    ...
    //echo '<span class="asset_status_up_down" style="color:red; font-size:28px;">'.$symbol.'</span>';
		...
		//aca termina la validacion
					   ...
					   ?></td>
                            <td><?php echo $ultimoba[0].$ultimoba[1]; ?>	</td>
                         <td><?php echo $pru[0]; ?>	</td>
						 <td class="alt"><?php echo $capitalba[0].$capitalba[1]; ?></td>
                         <td><?php echo  $cambioba[0].$cambioba[1]; ?></td>
                         <td class="alt"><?php echo $porcambioba[0]; ?></td>
                         <td><?php echo arrayAString($bid,','); ?></td>
                         <td class="alt"><?php echo arrayAString($bid,','); ?></td>
                         <td><?php echo arrayAString($bid,','); ?></td>
                         <td class="alt"><?php echo arrayAString($bid,','); ?></td>
...
if ($pos === false) {
   ...
   //si es positivo ingresa por aca
    ...
    // echo '<span style="color:green; font-size:28px;">'.$prut[0].'</span>';
			...
			echo '<span style="color:green; font-size:20px;">'.$symbolgo.'</span>';
   ...
   //si es negativo ingresa por aca 
    ...
    //echo '<span class="asset_status_up_down" style="color:red; font-size:28px;">'.$symbol.'</span>';
											...
											echo '<span style="color:red; font-size:20px;">'.$symbolgo.'</span>';
		...
		//aca termina la validacion
					 ...
					 ?></td>
                            <td><?php echo $ultimogo[0].$ultimogo[1]; ?>	</td>
                         <td><?php echo $pru[0]; ?>	</td>
						 <td class="alt"><?php echo $capitalgo[0].$capitalgo[1]; ?></td>
                         <td><?php echo  $cambiogo[0].$cambiogo[1]; ?></td>
                         <td class="alt"><?php echo $porcambiogo[0]; ?></td>
                         <td><?php echo arrayAString($bid,','); ?></td>
                         <td class="alt"><?php echo arrayAString($bid,','); ?></td>
                         <td><?php echo arrayAString($bid,','); ?></td>
                         <td class="alt"><?php echo arrayAString($bid,','); ?></td>
	 	  ...
	 	  <tbody>	  
                    <tr class="w3-hover-light-blue">
					   <td class="asset_status_up_down" style="color: rgb(255, 45, 19); font-size: 18px;"><i class="fa fa-caret-down"></i><?php echo 
...
if ($pos === false) {
   ...
   //si es positivo ingresa por aca
    ...
    // echo '<span style="color:green; font-size:28px;">'.$prut[0].'</span>';
			...
			echo '<span style="color:green; font-size:20px;">'.$symbolnv.'</span>';
   ...
   //si es negativo ingresa por aca 
    ...
    //echo '<span class="asset_status_up_down" style="color:red; font-size:28px;">'.$symbol.'</span>';
											...
											echo '<span style="color:red; font-size:20px;">'.$symbolnv.'</span>';
		...
		//aca termina la validacion
					 ...
					 ?></td>
                            <td><?php echo $ultimonv[0].$ultimonv[1]; ?>	</td>
                         <td><?php echo $pru[0]; ?>	</td>
						 <td class="alt"><?php echo $capitalnv[0].$capitalnv[1]; ?></td>
                         <td><?php echo  $cambionv[0].$cambionv[1]; ?></td>
                         <td class="alt"><?php echo $porcambionv[0]; ?></td>
                         <td><?php echo arrayAString($bid,','); ?></td>
                         <td class="alt"><?php echo arrayAString($bid,','); ?></td>
                         <td><?php echo arrayAString($bid,','); ?></td>
                         <td class="alt"><?php echo arrayAString($bid,','); ?></td>
